...
public class NodeInfo {
    ...
    private LocalDateTime lastHeartbeat; // Add lastHeartbeat for consistency, though master handles actual check

    public NodeInfo() {} // Necessário para Jackson

    public NodeInfo(String id, String region, int cpuCores, int ramMB, int currentLoad) {
        this.id = id;
        this.region = region;
        this.cpuCores = cpuCores;
        this.ramMB = ramMB;
        this.currentLoad = currentLoad;
        this.lastHeartbeat = LocalDateTime.now(); // Initialize heartbeat
    }
